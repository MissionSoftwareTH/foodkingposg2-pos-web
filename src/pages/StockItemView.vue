            ...
            <template #ProductInfo="product">
               <div class="flex items-center gap-4">
                    <div class="size-20 bg-base-100 rounded-lg overflow-hidden">
                        <img :src="product.item.ProductInfo.ProductImagePath" :alt="product.item.ProductInfo.ProductName" class="w-full h-full object-cover object-center">
                    </div>
                    <div class="">
                        <h1>{{ product.item.ProductInfo.ProductName }}</h1>
                        <h2 class="text-base-content/50 text-xs">{{product.item.ProductInfo.ProductCategoryId}}</h2>
                    </div>
               </div> 
            </template>
